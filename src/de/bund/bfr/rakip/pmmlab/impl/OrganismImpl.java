 ...
 * </p>
 * <ul>
 *   <li>{@link de.bund.bfr.rakip.pmmlab.impl.OrganismImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.bund.bfr.rakip.pmmlab.impl.OrganismImpl#getDetails <em>Details</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrganismImpl extends MinimalEObjectImpl.Container implements Organism {
	...
	protected EClass eStaticClass() {
		return pmmlabPackage.Literals.ORGANISM;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, pmmlabPackage.ORGANISM__NAME, oldName, name));
	}
	...
	public void setDetails(String newDetails) {
		...
		details = newDetails;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, pmmlabPackage.ORGANISM__DETAILS, oldDetails, details));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case pmmlabPackage.ORGANISM__NAME:
				return getName();
			case pmmlabPackage.ORGANISM__DETAILS:
				return getDetails();
		}
